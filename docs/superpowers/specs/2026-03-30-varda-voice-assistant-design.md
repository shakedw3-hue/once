...
- כן: שקטה כל היום, ואז: "שייקד, פגישה עם כהן עוד 15 דקות. תרצה שאשלח לו הודעה שאתה בדרך?"
...
- "שייקד, אתה עומד לשלוח מייל ללקוח ב-2 בלילה. רוצה שאתזמן לשליחה ב-8 בבוקר?"
- "שייקד, כבר דחית את הפגישה הזו פעמיים. הפעם הייתי שולחת."
- "שייקד, המייל הזה נשמע קצת חד. רוצה שארכך את הטון?"
...
|-------|---------------|-----------|
| פגישה עוד 15 דקות | "שייקד, כהן עוד 15 דקות. רוצה שאשלח לו שאתה בדרך?" | הרגע האחרון שאפשר עוד לפעול |
...
| טעות שעומדת לקרות | "שייקד, אתה שולח הצעה ללקוח LEVER בלי מחיר. בכוונה?" | מגנה עליך מפני עצמך |
...
| "שים לב שאתה שולח מייל בשעה מאוחרת" | "שייקד, 2 בלילה. אתזמן ל-8 בבוקר?" |
