        ...
        <>
          ...
          <div className="mb-4 space-y-3">
            <div className="flex items-center gap-3">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full" style={{ background: "rgba(99,102,241,0.2)" }}>
                <span className="text-xs font-bold" style={{ color: "#818CF8" }}>1</span>
              </div>
              <p className="text-xs text-white/70">
                ...
                <span className="font-semibold text-white">Share</span> button at the bottom of Safari
              </p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full" style={{ background: "rgba(99,102,241,0.2)" }}>
                <span className="text-xs font-bold" style={{ color: "#818CF8" }}>2</span>
              </div>
              <p className="text-xs text-white/70">
                Scroll down and tap <span className="font-semibold text-white">&ldquo;Add to Home Screen&rdquo;</span>
              </p>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full" style={{ background: "rgba(99,102,241,0.2)" }}>
                <span className="text-xs font-bold" style={{ color: "#818CF8" }}>3</span>
              </div>
              <p className="text-xs text-white/70">
                Open <span className="font-semibold text-white">Once.</span> from your home screen like any app
              </p>
            </div>
          </div>
          <button
